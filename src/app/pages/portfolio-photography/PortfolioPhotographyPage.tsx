              ...
              {works.map((work) => {
                ...
                return (
                  <Link key={work.id} to={`/portfolio/${work.id}`}
                    className="group bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-cyan-500 transition-all hover:shadow-xl hover:shadow-cyan-500/20 flex flex-col sm:flex-row h-auto sm:h-48">
