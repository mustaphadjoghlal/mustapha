          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="#services" className="px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all font-semibold">
                  استكشف خدماتي
                </a>
                <Link to="/about" className="px-8 py-3 border border-gray-600 rounded-lg hover:border-blue-400 hover:text-blue-400 transition-all font-semibold">
                  المزيد عني
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {clients.map((client) => (
                <div key={client.id}
                  ...
                  <p className="text-center text-gray-400 text-sm font-semibold group-hover:text-white transition-all">
                    {client.name}
                  </p>
                </div>
              ))}
